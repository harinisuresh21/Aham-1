...
const HeroContent = () => {
  return (
    <div className="relative z-20 w-full max-w-[520px] flex flex-col items-start lg:-mt-8">
      ...
      {/* Headline */}
      <h1 className="text-[clamp(36px,9vw,48px)] md:text-[clamp(42px,5vw,56px)] lg:text-[clamp(48px,4.5vw,64px)] font-serif leading-[1.05] mb-4 lg:mb-5 tracking-tight text-[#243D2B] font-semibold">
      ...
      {/* Concise Description */}
      <p className="text-[14px] sm:text-[15px] lg:text-[16px] text-[#243D2B]/90 font-medium mb-5 lg:mb-6 w-full lg:max-w-[440px] leading-[1.55] font-sans drop-shadow-[0_1px_1px_rgba(255,255,255,0.6)]">
      ...
      <div className="flex flex-row flex-wrap items-center gap-3.5 sm:gap-4 lg:gap-5">
        <Link to="/products" className="shrink-0">
          <Button size="lg" className="px-7 sm:px-8 bg-[#243D2B] hover:bg-[#243D2B]/90 text-white rounded-xl h-11 lg:h-[46px] text-[13px] sm:text-[14px] font-semibold tracking-wide shadow-md hover:shadow-lg transition-all">
            Shop Now
          </Button>
        </Link>
      </div>
