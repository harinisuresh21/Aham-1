  ...
  return (
    <div className="bg-brand-cream-light py-16 min-h-[calc(100vh-80px)] flex items-center">
      <Container className="max-w-md">
        <div className="bg-white p-8 md:p-10 border border-brand-border shadow-sm">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-serif text-brand-primary mb-2">Welcome Back</h1>
            <p className="text-sm text-brand-muted">Sign in to your AHAM account.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex justify-end">
              <a href="#" className="text-xs font-medium text-brand-primary hover:underline">Forgot password?</a>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-brand-muted">
            Don't have an account? <Link to="/register" className="font-medium text-brand-primary hover:underline">Register</Link>
          </p>
        </div>
      </Container>
    </div>
